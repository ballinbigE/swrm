...
Single maintainer (Erick Bzovi). Cadence: evenings + weekends, best-effort.
...
- Real-time chat support (no Discord/Slack — file issues).
- Backports to old majors (will support latest major + N-1 once we hit 1.0).
...
This project will not consume my evenings indefinitely. If it grows past what one person can sustain, I'll either onboard co-maintainers or scale back features. Either way I'll be transparent about it.
